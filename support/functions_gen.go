...
func doScanStringList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]string, error) {
	var v string
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanStringPtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]string, error) {
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanIntList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int, error) {
	var v int
	list := make([]int, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanIntPtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int, error) {
	var v sql.NullInt64
	list := make([]int, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt64List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int64, error) {
	var v int64
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt64PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int64, error) {
	var v sql.NullInt64
	list := make([]int64, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt32List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int32, error) {
	var v int32
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt32PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int32, error) {
	var v sql.NullInt64
	list := make([]int32, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt16List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int16, error) {
	var v int16
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt16PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int16, error) {
	var v sql.NullInt64
	list := make([]int16, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt8List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int8, error) {
	var v int8
	list := make([]int8, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanInt8PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]int8, error) {
	var v sql.NullInt64
	list := make([]int8, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUintList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint, error) {
	var v uint
	list := make([]uint, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUintPtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint, error) {
	var v sql.NullInt64
	list := make([]uint, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint64List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint64, error) {
	var v uint64
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint64PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint64, error) {
	var v sql.NullInt64
	list := make([]uint64, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint32List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint32, error) {
	var v uint32
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint32PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint32, error) {
	var v sql.NullInt64
	list := make([]uint32, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint16List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint16, error) {
	var v uint16
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint16PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint16, error) {
	var v sql.NullInt64
	list := make([]uint16, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint8List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint8, error) {
	var v uint8
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanUint8PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]uint8, error) {
	var v sql.NullInt64
	list := make([]uint8, 0, 10)
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanFloat64List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]float64, error) {
	var v float64
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanFloat64PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]float64, error) {
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanFloat32List(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]float32, error) {
	var v float32
...
// The result set should have been produced via a SELECT statement on just one column.
func doScanFloat32PtrList(req require.Requirement, rows sqlapi.SqlRows, qLog func(error) error) ([]float32, error) {
	var v sql.NullFloat64
	list := make([]float32, 0, 10)
