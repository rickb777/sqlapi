...
import (
	...
	"github.com/mercury-holidays/sqlapi/pgxapi/support"
...
func (rel Relationship) IdsUnusedAsForeignKeys(tbl pgxapi.Table) (util.Int64Set, error) {
...
func (rel Relationship) IdsUsedAsForeignKeys(tbl pgxapi.Table) (util.Int64Set, error) {
	if rel.Parent.Column == "" || rel.Child.Column == "" {
